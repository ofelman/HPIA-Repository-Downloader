...
$ScriptVersion = "1.83 (August-6-2021)"
...
if ( $help ) {
    ...
    "`nHPIARepo_Downloader_1.83.ps1 [[-Sync] [-ListFilters] [-inifile .\<filepath>\HPIARepo_ini.ps1] [-RepoStyle common|individual] [-products '80D4,8549,8470'] [-NoIniSw] [-ShowActivityLog]]`n"
    ...
    "`nExample: HPIARepo_Downloader_1.83.ps1 .\<path>\HPIARepo_ini.ps1 Common '80D4,8549,8470'`n"    
...
Function CreateForm {
    ...
    $AddModelButton.Location = New-Object System.Drawing.Point(($LeftOffset),($FormHeight-447))    # (from left, from top)
    $AddModelButton.Text = 'Add NEW Model'
