...
$ScriptVersion = "1.85 (August 9, 2021)"
...
Function Update_INIModels {
	...
	param( $pGrid,
        $pRepositoryFolder,
        $pCommonRepoFlag )                 # True = Common/shared repository
...
Function Ask_AddEntry {
    ...
    $EntryId.location = New-Object System.Drawing.Point($LeftOffset,$TopOffset) # (from left, from top)
    ...
    $EntryModel.location = New-Object System.Drawing.Point(($LeftOffset+70),($TopOffset-4)) # (from left, from top)
    ...
    $SearchButton.Location = New-Object System.Drawing.Point(($PathFieldLength+$LeftOffset+80),($TopOffset-6))
    ...
    $AddEntryList.location = New-Object System.Drawing.Point($LeftOffset,80)  # (from left, from top)
    $AddEntryList.Size = New-Object System.Drawing.Size(($EntryFormWidth-60),($EntryFormHeigth/2-20)) # (width, height)
    $AddEntryList_DoubleClick = {
        return $AddEntryList.SelectedItem
    }
    $AddEntryList.add_DoubleClick($AddEntryList_DoubleClick)

    $okButton = New-Object System.Windows.Forms.Button
    $okButton.Location = New-Object System.Drawing.Point(($EntryFormWidth-120),($EntryFormHeigth-100))
    $okButton.Size = New-Object System.Drawing.Size(75,23)
    $okButton.Text = 'OK'
    $okButton.DialogResult = [System.Windows.Forms.DialogResult]::OK

    $EntryForm.AcceptButton = $okButton
    $EntryForm.Controls.AddRange(@($EntryId,$EntryModel,$AddEntryList, $SearchButton, $okButton))

    $lResult = $EntryForm.ShowDialog()

    if ($lResult -eq [System.Windows.Forms.DialogResult]::OK) {
        return Get-HPDeviceDetails -Like -Name $AddEntryList.SelectedItem
    }
...
Function CreateForm {
    ...
    $AddModelButton.add_Click( { 
        if ( ($lModel = Ask_AddEntry) -ne $null ) {
            [void]$DataGridView.Rows.Add( @( $False, $lModel.SystemID, $lModel.Name) )
            $Script:ModelAdded = $True
            CMTraceLog -Message "$($lModel.SystemID):$($lModel.Name) added to list" -Type $TypeNorm
