...
$ScriptVersion = "2.05.08 (Jul 27, 2026)"
...
if ( $help ) {
    ...
    "`nHPIARepo_Downloader_2.05.08.ps1 [[-Sync] [-ListFilters] [-inifile .\<filepath>\HPIARepo_ini.ps1] [-RepoStyle common|individual] [-products '80D4,8549,8470'] [-NoIniSw] [-ShowActivityLog]]`n"
    ...
    "`nExample: HPIARepo_Downloader_2.05.08.ps1 .\<path>\HPIARepo_ini.ps1 Common '80D4,8549,8470'`n"    
...
Function Import-IndividualRepos {
    ...
    foreach ( $iPath in $ii_Directories ) { 
        ...
        Try {
            ...
            [array]$ir_RepoPlatform = (Get-RepositoryInfo).Filters.platform
