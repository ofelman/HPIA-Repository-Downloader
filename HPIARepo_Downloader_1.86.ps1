...
$ScriptVersion = "1.86 (August 10, 2021)"
...
if ( $help ) {
    ...
    "`nHPIARepo_Downloader_1.85.ps1 [[-Sync] [-ListFilters] [-inifile .\<filepath>\HPIARepo_ini.ps1] [-RepoStyle common|individual] [-products '80D4,8549,8470'] [-NoIniSw] [-ShowActivityLog]]`n"
    ...
    "`nExample: HPIARepo_Downloader_1.85.ps1 .\<path>\HPIARepo_ini.ps1 Common '80D4,8549,8470'`n"    
...
Function CreateForm {
    ...
    $AddModelButton.add_Click( { 
        ...
        if ( ($lModelArray = AddEntryForm $DataGridView $Script:v_Softpaqs $lTempPath $Script:v_CommonRepo ) -ne $null ) {
